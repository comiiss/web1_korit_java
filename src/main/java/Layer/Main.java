...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        /* 큰 세 가지 축
            ...
            --> www.naver.com : 서버 주소
            --> www.naver.com/news
            서버 주소 이후에 등장하는 /는 컨트롤러 경로
            Service - 비즈니스 로직 작성
            Repository - 데이터 베이스 연결(+ 쿼리)
        ...
        //2. 의존성 주입 main에서 싱글톤 객체들을 생성 및 조립

        //인터페이스를 통해서 결합도를 낮추는 것이 권장된다 - 변경에 용이
        ...
        while(true) {
            ...
            if(menu == 1) {
                ...
                SignupReqDto reqDto = new SignupReqDto(username, password);
