...
public class Practice {
    public static void main(String[] args) {
        ...
        //1. 재고가 35 미만인 상품들의 이름을 출력하세요
        for(int i = 0; i < intventory.length; i++) {
            int[] information = intventory[i];
        ...
        //2. inventory의 총 가치를 구해 주세요
        //재고 * 가격
        int totalSum = 0;

        for(int[] information : intventory) {
            int stock = information[0];
        ...
        if(targetIdx == -1) {
            ...
            return; //메서드 즉시 종료 - main 즉시 종료

        } //얼리리턴 패턴

        System.out.println("찾았습니다");
        int[] targetInfo = intventory[targetIdx];
        System.out.println("==============");
