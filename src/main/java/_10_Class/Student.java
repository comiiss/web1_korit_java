...
public class Student {
    ...
    //생성자 - new 연산시, 호출되는 메서드
    //엄밀히 말하면, 메서드가 아니다
    //return 명시 X, 클래스와 동일한 이름
    public Student() {
        //매개 변수 하나도 없는 생성자
        //기본 생성자
        System.out.println("기본 생성자 호출됨");

        //기본적으로 자바는 클래스 하나를 만들 때
        //생성자 하나를 자동적으로 만든다
    ...
    //객체 메서드(static가 아닌 메서드 곧 this가 있는 메서드)
    public void printInfo() {
        ...
        System.out.println("평균: " + this.getAvgScore());
    ...
    // student 객체의 평균 점수를 리턴하는 인스턴스 메서드
    //-> printInfo 인스턴스 메서드에 총점과 평균 점수 출력 코드 추가
